        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-6">
                <div class="flex flex-col items-center text-center">
                    ...
                    <label
                        class="mt-4 inline-block cursor-pointer rounded-lg border border-gray-300 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                        Ganti Foto
            ...
            <div class="lg:col-span-2 bg-white border border-gray-200 rounded-2xl p-6">
                ...
                <form class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text"
                                ...
                                placeholder="Nomor Induk Mahasiswa" disabled />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea rows="3" class="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2 text-sm"
