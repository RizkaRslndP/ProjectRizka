        ...
        <nav aria-label="Global" class="flex items-center justify-between p-6 lg:px-8">
            <div class="flex lg:flex-1">
                <a href="/dashboard" class="-m-1.5 p-1.5">
                    <span class="sr-only">IAI AL-AZIZ</span>
                    <img src="{{ Vite::asset('resources/assets/Logo-IAI-AL-AZIS.png') }}" alt=""
                        class="h-10 w-auto" />
                </a>
            </div>
                        ...
                        <div class="mt-6 flow-root">
                            <div class="-my-6 divide-y divide-white/10">
                                <div class="space-y-2 py-6">
                                    <a href="/dashboard"
                                        class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-white hover:bg-white/5">Dashboard</a>
                                    <a href="/blog"
                                        class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-white hover:bg-white/5">Blog</a>
                                    <a href="/contact"
