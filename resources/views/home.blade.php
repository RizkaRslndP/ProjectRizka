    ...
    <div class=" bg-white py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:mx-0">
                ...
                <p class="mt-2 text-lg/8 text-gray-900">Learn how to grow your business with our expert advice.</p>
            </div>
            <div
                ...
                <article class="flex max-w-xl flex-col items-start justify-between">
                    <div class="flex items-center gap-x-4 text-xs">
                        ...
                        <a href="#"
                            class="relative z-10 rounded-full bg-gray-900/60 px-3 py-1.5 font-medium text-gray-300 hover:bg-gray-800">Marketing</a>
                    </div>
                    <div class="group relative grow">
                        ...
                        <p class="mt-5 line-clamp-3 text-sm/6 text-gray-900">Illo sint voluptas. Error voluptates culpa
                ...
                <article class="flex max-w-xl flex-col items-start justify-between">
                    <div class="flex items-center gap-x-4 text-xs">
                        ...
                        <a href="#"
                            class="relative z-10 rounded-full bg-gray-800/60 px-3 py-1.5 font-medium text-gray-800 hover:bg-gray-800">Sales</a>
                    </div>
                    <div class="group relative grow">
                        <h3 class="mt-3 text-lg/6 font-semibold text-gray-900 group-hover:text-gray-600">
                            <a href="#">
                        ...
                        <p class="mt-5 line-clamp-3 text-sm/6 text-gray-900s">Optio cum necessitatibus dolor voluptatum
                ...
                <article class="flex max-w-xl flex-col items-start justify-between">
                    <div class="flex items-center gap-x-4 text-xs">
                        ...
                        <a href="#"
                            class="relative z-10 rounded-full bg-gray-800/60 px-3 py-1.5 font-medium text-gray-800 hover:bg-gray-800">Business</a>
                    </div>
                    <div class="group relative grow">
                        <h3 class="mt-3 text-lg/6 font-semibold text-gray-900 group-hover:text-gray-600">
                            <a href="#">
                        ...
                        <p class="mt-5 line-clamp-3 text-sm/6 text-gray-900">Cupiditate maiores ullam eveniet adipisci
                    ...
                    <div class="relative mt-8 flex items-center gap-x-4 justify-self-end">
                        ...
                        <div class="text-sm/6">
                            ...
                            <p class="text-gray-500">Director of Product</p>
                        </div>
                    </div>
                </article>
            </div>
